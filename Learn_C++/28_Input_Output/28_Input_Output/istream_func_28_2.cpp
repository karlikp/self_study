...
void ex_2_3() // 'std::cin' discard whitespace 
{
	char ch;
	while (std::cin >> ch)
		std::cout << ch;
...
void ex_2_4() //get() function extract even whitespace
{
	char ch;
...
void ex_2_5() //std::get() also has a string version with limit to read 
{
